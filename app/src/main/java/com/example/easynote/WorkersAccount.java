...
public class WorkersAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workers_account);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseFirestore.getInstance().collection(Name+" worker").addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
